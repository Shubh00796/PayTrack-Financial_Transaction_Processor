...
public class UserController {
    ...
    public ResponseEntity<Page<UserResponseDTO>> getUsersByStatus(@PathVariable UserStatus status, Pageable pageable) {
    ...
    public ResponseEntity<Boolean> isUserLocked(@PathVariable String userId) {
